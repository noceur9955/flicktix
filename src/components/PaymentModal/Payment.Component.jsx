...
const PaymentModel = ({ setIsOpen, isOpen, price }) => {
  ...
  const launchRazorPay = () => {
    let options = {
      key: "rzp_test_IvtCyBBk06aboU",
      amount: price * 100,
      currency: "INR",
      name: "Flick_Tix",
      description: "Movie purchase or rental",
      image:
        "https://graciamarcom.com/es/wp-content/uploads/sites/6/2018/02/Logo-design.png",
      handler: () => {
        setIsOpen(false);
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4 flex gap-3">
                    <button
                      type="button"
                      className="inline-flex justify-center rounded-md border border-transparent bg-green-500 px-4 py-2 text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
