      ...
      <div>
        ...
        <div className="flex flex-col gap-3 lg:hidden">
          ...
          <div className="flex items-center gap-3 md:px-4 md:w-screen text-xl px-4">
            <button onClick={rentMovie} className="bg-yellow-500 w-full py-3 text-white font-semibold rounded-lg">
              Rent ₹149
            </button>
            <button onClick={buyMovie} className="bg-yellow-600 w-full py-3 text-white font-semibold rounded-lg">
              Buy ₹599
            </button>
          </div>
        </div>
